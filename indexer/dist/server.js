...
import { computeEventUid, extractFundraisingEvents, extractTopLevelMeta, } from "./chainhook.js";
const env = loadEnv();
...
app.post("/chainhook", async (req, res) => {
    ...
    try {
        await db.query(`insert into chainhook_deliveries
       ...
       on conflict (event_uid) do nothing`, [
        ...
        for (const ev of extracted) {
            await db.query(`insert into fundraising_events
